...
import 'package:flutter_rest_api/network/EmployeesClient.dart';
...
class _EmployeePageState extends State<EmployeePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: EmployeesClient().getEmployee(),
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  title: Text(emps.data[index].employeeName),
                  subtitle: Text('Age: ${emps.data[index].employeeAge}'),
                );
              },
              itemCount: emps.data.length,
            );
          }
          return Center(
              ...
              RaisedButton(
                ...
                onPressed: () {
                  final body = {
                    ...
                    "employee_age": _employeeAge.text,
                  };
                  EmployeesClient().addEmployee(body).then((success) {
                    if (success) {
                      showDialog(
